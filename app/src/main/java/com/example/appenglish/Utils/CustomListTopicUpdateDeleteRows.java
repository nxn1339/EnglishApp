...
public class CustomListTopicUpdateDeleteRows extends BaseAdapter {
    Context c;
    ArrayList<Topic> topics;

    public CustomListTopicUpdateDeleteRows(Context c, ArrayList<Topic> topics) {
        this.c = c;
        this.topics = topics;
    }
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        if(view==null)
        {
            view= LayoutInflater.from(c).inflate(R.layout.listview_topic_row,viewGroup,false);
        }
